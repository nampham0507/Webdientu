  ...
  <body>
    ...
    <main class="container">
      ...
      <div class="products-section mt-3">
        ...
        <!-- Các sản phẩm -->
        <div
          class="d-flex flex-wrap mt-3 justify-content-md-center justify-content-left"
        >
          <!-- SP 1-->
          <a
          ...
          >
            ...
            <img
              src="{{asset('images/Products/Product1/iphone-16-pro-max-titan-sa-mac.webp')}}"
              class="card-img-top mt-4"
              alt="CPU AMD Ryzen 5 5600"
            />
            ...
            <div class="card-body p-0 mt-2">
              ...
              <div class="d-flex align-items-baseline gap-2">
                <span class="text-danger fw-bold fs-6">29.741.000đ</span>
                <small class="text-muted text-decoration-line-through"
                  >34.990.000đ</small
                >
              </div>
          ...
          >
            ...
            <img
              src="{{asset('images/Products/Product2/Product2-Anh9.jpg')}}"
              class="card-img-top mt-4"
              alt="CPU AMD Ryzen 5 5600"
            />

            <div class="card-body p-0 mt-2">
              <h6 class="card-title mb-2">Máy lọc không khí Levoit</h6>
              <div class="d-flex align-items-baseline gap-2">
                <span class="text-danger fw-bold fs-6">2.590.000đ</span>
                <small class="text-muted text-decoration-line-through"
                  >3.636.363đ</small
                >
              </div>
              <div class="bg-light text-secondary small px-2 py-1 rounded mt-1">
                Smember giảm đến 36.000đ
              </div>
              <div class="d-flex flex-row-reverse mt-2">
                <btn class="btn btn-primary">♡ Yêu thích</btn>
              </div>
          ...
          >
            ...
            <img
              ...
              class="card-img-top mt-4"
              alt="MacBook Pro 14 M4 10CPU 10GPU 24GB 1TB"
            />

            <div class="card-body p-0 mt-2">
              <h6 class="card-title mb-2">
                MacBook Pro 14 M4 10CPU 10GPU 24GB 1TB
              </h6>
              <div class="d-flex align-items-baseline gap-2">
                <span class="text-danger fw-bold fs-6">48.390.000đ</span>
                <small class="text-muted text-decoration-line-through"
                  >49.990.000đ</small
                >
              </div>
              <div class="bg-light text-secondary small px-2 py-1 rounded mt-1">
                Giá S-Student 47.990.000đ
              </div>
              <div class="d-flex flex-row-reverse mt-2">
                <btn class="btn btn-primary">♡ Yêu thích</btn>
              </div>
    ...
    <footer>
      ...
      <!-- Dòng bản quyền -->
      <div class="footer-bottom">©Bản quyền SDevices.</div>
    </footer>
