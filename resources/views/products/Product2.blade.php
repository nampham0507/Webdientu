...
<html lang="en">
  <head>
    ...
    <title>Máy lọc không khí chống dị ứng thú cưng Levoit Vital 100S</title>
    <!-- Bootstrap -->
    <link
  ...
  <body>
    ...
    <main class="container mt-3">
      ...
      <div class="d-flex" style="font-size: small">
        ...
        <p>
          <b>
            Trang chủ / Nhà thông minh / Máy lọc không khí / Máy lọc không khí
            Levoit /</b
          >
          Máy lọc không khí chống dị ứng thú cưng Levoit Vital 100S
        </p>
      </div>
      ...
      <div class="product-container row">
        ...
        <div class="col-12 col-md-6">
          <!-- Tên sản phẩm -->
          <h4>Máy lọc không khí chống dị ứng thú cưng Levoit Vital 100S</h4>
          <div class="d-flex">
            <i class="fa-solid fa-star mt-1 me-2" style="color: #ffd43b"></i>
            <p><b>5</b> (36 đánh giá)</p>
          </div>
          ...
          <div class="product-specifications mt-4">
            ...
            <table class="mt-2 table table-border shadow rounded custom-table">
              <tr>
                <td class="bg-body-secondary" width="40%">Diện tích sử dụng</td>
                <td>52m²</td>
              </tr>
              <tr>
                <td class="bg-body-secondary">Hiệu quả lọc bụi</td>
                <td>PM 2.5</td>
              </tr>
              <tr>
                <td class="bg-body-secondary">Lưu lượng gió</td>
                <td>243 m³/h</td>
              </tr>
              <tr>
                <td class="bg-body-secondary">Màng lọc</td>
                <td>
                  Lọc bụi thô<br />Bộ lọc H13 True HEPA<br />Lọc mùi than hoạt
                  tính
                </td>
              </tr>
              <tr>
                <td class="bg-body-secondary">Độ ồn</td>
                <td>23 - 52 dB</td>
              </tr>
              <tr>
                <td class="bg-body-secondary">Chế độ hoạt động</td>
                <td>Chế độ ngủ<br />Chế độ tự động<br />Chế độ thú cưng</td>
              </tr>
              <tr>
                <td class="bg-body-secondary">Tiện ích</td>
                <td>
                  Điều khiển từ xa<br />Cập nhật chất lượng không khí<br />Hiển
                  thị ra lịch trình<br />Chức năng hẹn giờ<br />Trợ lí ảo Google
                  Assistant, Alexa<br />Công nghệ khử mùi<br />Khóa màn hình
                </td>
              </tr>
              <tr>
        ...
        <div class="col-12 col-md-6">
          ...
          <div class="version mt-4">
            ...
            <div role="group" aria-label="Chọn dung lượng">
              <input
                ...
                checked
              />
              <label class="btn px-4 py-3 mx-1" for="storage1">100S</label>
              ...
              <input
                ...
                autocomplete="off"
              />
              <label class="btn px-4 py-3 mx-1" for="storage2">200S</label>
            </div>
          ...
          <div class="container my-4">
            <div class="ratio ratio-16x9 border rounded shadow">
              <iframe
                src="https://www.youtube.com/embed/v1VKcIZIgFI"
      ...
      <div class="comment-container mt-4">
        <h4 class="m-3">Đánh giá máy lọc không khí Levoit Vital 100S</h4>
        ...
        <div class="rating-container mt-5 m-3">
          ...
          <div class="row mt-2">
            ...
            <div class="col-9">
              ...
              <div class="my-2">Máy lọc không khí mua ở đây ổn áp đấy</div>
          ...
          <div class="row mt-2">
            ...
            <div class="col-9">
              ...
              <div class="my-2">
                Nhà nuôi mèo như mình dùng loại này rất hợp
              </div>
              <div class="d-flex my-1">
                <i
                  class="fa-regular fa-clock me-1 mt-1"
          ...
          <div class="row mt-2">
            ...
            <div class="col-9">
              ...
              <div class="my-2">Sản phẩm dùng tốt, thiết kế sang</div>
              <div class="d-flex my-1">
                <i
                  class="fa-regular fa-clock me-1 mt-1"
                  style="color: #a1a1bd"
    ...
    <footer>
      <div class="footer-container">
        ...
        <!-- Mạng xã hội -->
        <div class="footer-column">
          <h3>Mọi câu hỏi xin liên hệ:</h3>
          <ul>
            <li><a href="https://www.facebook.com/pdn.0507/">Facebook</a></li>
            <li><a href="#">Zalo: 0383392903</a></li>
          </ul>
        </div>
      </div>
